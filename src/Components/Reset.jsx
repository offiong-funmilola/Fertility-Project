...
function Reset() {
    ...
    return (
        <section className='w-full max-h-fit reg'>
            ...
            <div className='reg w-full h-fit py-28'>
                <div className='w-full h-full flex items-center justify-center'>
                    <div className='w-full h-full md:w-3/5 bg-white flex flex-col items-center rounded-lg px-12 md:px-6 lg:px-28 xl:px-36 '>
                        ...
                        <div className='w-full h-full flex flex-col font-normal text-base'>
                            <form className='w-full h-fit flex flex-col my-6 px-9' onsubmit={formik.handleSubmit}>
                                ...
                                <div className='w-full mb-10 relative'>
                                    ...
                                    <input type={type} name='confirmPassword' placeholder='' className='p-3 px-5 w-full border-2 border-slate-400 rounded-lg'
                                ...
                                <Link to='/login' className='back w-3/4 self-center flex items-center justify-center rounded-sm'>
                                    <button type='submit' disabled={!formik.isValid} className='w-full p-3 border-0 text-lg text-white font-bold font-sans disabled:bg-lime-800'>Reset Password</button>
                                </Link>
                            </form>
