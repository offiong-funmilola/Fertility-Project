...
// require("yup-phone");
// localStorage.setRegistered('Registered users', JSON.stringify(response));
...
function Register() {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            submit("http://localhost:5000/registers", values);
                            ...
                            <form className='w-full flex flex-col my-6 px-3' onSubmit={formik.handleSubmit}>
                                <div className='w-full grid grid-cols-2 gap-x-14 gap-y-3 md:grid-cols-2'>
                                    ...
                                    <div className='w-full mb-3 relative'>
                                        ...
                                        <input type='password' id='password' name='password' placeholder='password' className='p-3 px-5 w-full border-2 border-slate-400 rounded-lg'
                                    ...
                                    <div className='w-full mb-3 relative'>
                                        ...
                                        <input type='password' id='confirmPassword' name='confirmPassword' placeholder='password' className='p-3 px-5 w-full border-2 border-slate-400 rounded-lg'
                                ...
                                <Link to='/registration' className='back w-3/4 self-center flex items-center justify-center rounded-sm mt-11 mb-6'>
                                    <button type='submit' disabled={!formik.isValid} className='w-full p-3 border-0 text-lg text-white font-bold font-sans disabled:bg-green-900'>Register</button>
                                </Link>
